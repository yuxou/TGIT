    ...
    <jsp:include page="header.jsp" />
	   <%
	    ...
	    if (keyword == null || keyword.trim().isEmpty()) {
	        keyword = "검색어 없음"; // 기본값 설정
	    }
	    request.setAttribute("keyword", keyword); // EL 참조를 위해 설정
	%>
    ...
    <div class="results">
        ...
        <div class="placeResults">
			...
			<button class="more-results-btn" 
			        onclick="location.href='${pageContext.request.contextPath}/searchPlace.jsp?keyword=' + encodeURIComponent('${keyword}')">
			    장소 검색결과 더보기
			</button>
        </div>
        <div class="planResults">
                ...
                <c:when test="${not empty plans}">
                    <c:forEach var="plan" items="${plans}">
                        <div class="schedule-item">
                            <p class="number"><c:out value="${plan.planId}" /></p>
                            <p class="title">
            ...
            <button class="more-results-btn" 
			        onclick="location.href='${pageContext.request.contextPath}/searchPlan.jsp?keyword=' + encodeURIComponent('${keyword}')">
			    일정 검색결과 더보기
			</button>
        </div>
    </div>
